...
`@script`
It is hard to choose which of our models we should fit by looking at the time series. These two time series look very similar, but the model we choose is very important. If we make the wrong choice of model to fit we can end up with poor forecasts.
...
*The PACFtells us how much our time series is correlated with itself at a lag of n removing the correlations caused by smaller lags
