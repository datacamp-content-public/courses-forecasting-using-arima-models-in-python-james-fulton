...
![](https://assets.datacamp.com/production/repositories/4399/datasets/30324bcef941b32eecc7653fa77b6026aafab959/complex_pandas_generated_data.png)
...
=====================================================================================
                        coef    std err          z      P>|z|      [0.025      0.975]
-------------------------------------------------------------------------------------
const                -0.0053      0.803     -0.007      0.995      -1.579       1.569
ar.L1.time_series     0.5308      0.073      7.244      0.000       0.387       0.674
ar.L2.time_series     0.3658      0.073      4.979      0.000       0.222       0.510
ma.L1.time_series     0.2833      0.067      4.216      0.000       0.152       0.415
ma.L2.time_series    -0.0464      0.042     -1.095      0.274      -0.129       0.037
ma.L3.time_series     0.4897      0.050      9.878      0.000       0.393       0.587
=====================================================================================
```{{2}}
...
Finally we print the model parameters from the results object. You can see that the two ar coefficients are close to the two ar coefficents we used to generate the data and that the 3 MA coefficients are also close invalue to the 3 we used to generate the data.
