...
Finally we print the model parameters from the results object. You can see that the two ar coefficients are close to the two ar coefficents we used to generate the data and that the 2 MA coefficients are also close invalue to the 2 we used to generate the data.
