...
`@script`
Using the fitted model we can now make predictions about future flu rate using the get_predictions method. We'll discuss forecasts further in a later video but lets zoom in for a closer look at how our predictions compare to reality
